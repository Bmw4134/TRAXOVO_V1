...
@app.route('/api/groundworks-projects')
def groundworks_projects():
    """Authentic Groundworks Project Management Data"""
    return jsonify({
        "status": "operational",
        "projects": [
            {
        ...
        "total_projects": 3,
        "active_projects": 2,
        "total_project_value": 8050000,
        "last_updated": "2025-06-10T21:22:00Z",

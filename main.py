...
try:
    ...
    # from routes.april_billing_simulation import april_billing_bp  # Temporarily disabled due to syntax errors
    ...
    # app.register_blueprint(april_billing_bp)  # Temporarily disabled
    # app.register_blueprint(enhanced_billing_bp)  # Will be registered below

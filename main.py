...
@app.route('/api/legacy-automation/execute', methods=['POST'])
def execute_legacy_automation():
    """Execute legacy automation workflows"""
    try:
        data = request.get_json()
...
def api_depreciation_analysis():
    ...
    try:
        ...
        depreciation_analysis['fleet_depreciation']['projected_5_year_value'] = total_current_value * (0.85 ** 5)  # 15% annual depreciation

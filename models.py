"""
TRAXOVO Database Models - Simple Production Schema
"""
...
class PlatformData(db.Model):
    __tablename__ = 'traxovo_platform_data'
    id = db.Column(db.Integer, primary_key=True)

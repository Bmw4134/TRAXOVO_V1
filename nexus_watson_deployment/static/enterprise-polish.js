...
(function () {
  ...
  function preventLayoutShift() {
    ...
    var metricElements = document.querySelectorAll(
  ...
  function addLoadingStates() {
    ...
    for (var i = 0; i < metricCards.length; i++) {
      ...
      if (
        metricValue &&
        (metricValue.textContent === "--" || metricValue.textContent === "")
      ) {
        metricValue.style.background =
  ...
  function enhanceMobileSidebar() {
    ...
    overlay.style.cssText =
      "position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 1000; opacity: 0; visibility: hidden; transition: all 0.3s ease;";

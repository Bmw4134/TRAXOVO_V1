"""
TRAXORA Fleet Management System - Daily Driver Report Routes

This module provides routes for automatically generating daily driver attendance reports,
replacing the manual process with a fully automated system.
"""

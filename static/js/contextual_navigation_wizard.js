...
`;
  ...
  showQuickTour() {
    const tourSteps = [
      {
        element: ".sidebar",
        content: "Navigate between modules using this sidebar",
      },
      {
        element: ".dashboard-metrics",
        content: "Key performance indicators are displayed here",
      },
      {
        element: ".data-refresh",
        content: "Use this to refresh your real-time data",
      },
    ];

...
class GeniusCoreManifest {
    constructor() {
        ...
        // Register system manifest agent
        this.manifestAgent = {
            id: 'SystemManifest',
    ...
    initializeManifest() {
        // Register core agents in the manifest
    ...
    registerWithBroadcaster() {
        // Add message listener for status broadcasts
    ...
    broadcastManifestStatus() {
        ...
        // Broadcast to all windows/frames
        window.postMessage({
    ...
    createManifestDisplay() {
        // Check if manifest display already exists

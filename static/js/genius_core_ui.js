...
// Create the UI components when the document is loaded
document.addEventListener('DOMContentLoaded', function() {
    // Wait a bit to ensure the map is loaded
...
function createUIComponents() {
    ...
    // Create the module status panel
    createModuleStatusPanel();
    
    // Create the system manifest button
...
function addGlobalStyles() {
    ...
    // Add the other UI components after a short delay
    setTimeout(() => {

    ...
    this.tourSteps = [
      {
        ...
        content:
          "Your comprehensive fleet management intelligence platform. This dashboard shows real-time data from your 717 assets worth $1.88M.",
        position: "bottom",
      },
      {
        ...
        title: "Total Assets",
        content:
          "Track your complete fleet inventory. Currently showing 717 total assets from your Foundation registry.",
        position: "bottom",
      },
      {
        ...
        title: "Active Assets",
        content:
          "Monitor equipment currently deployed. Your utilization rate is 91.7% with 614 active assets.",
        position: "bottom",
      },
      {
        ...
        content:
          "View monthly revenue from billable assets. Current revenue: $847.2K from Foundation accounting data.",
        position: "bottom",
      },
      {
        ...
        content:
          "Access comprehensive driver attendance tracking for your 92 drivers. Monitor late starts, early ends, and no-shows.",
        position: "right",
      },
      {
        ...
        title: "Asset Manager",
        content:
          "Manage your entire equipment fleet. Track maintenance, utilization, and profitability by asset.",
        position: "right",
      },
      {
        ...
        content:
          "Real-time GPS tracking of your assets. Monitor location, geofences, and job site assignments.",
        position: "right",
      },
      {
        target: '[href="/billing"]',
        ...
        content:
          "Revenue analytics using authentic Foundation cost data. Track profitability and billing accuracy.",
        position: "right",
      },
      {
        ...
        content:
          "VP and Controller-ready reports with KPI dashboards and exportable analytics.",
        position: "right",
      },
    ];
    this.overlay = null;

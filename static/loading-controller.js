...
class LoadingController {
    ...
    setupEventListeners() {
        // Listen for AJAX requests and form submissions
    ...
    hideLoading(targetId) {
        ...
        if (container) {
            ...
            // Remove loading classes and restore content
    ...
    simulateDataLoading(targetId, duration = 2000) {
        // Simulate realistic loading times for demo purposes
        setTimeout(() => {
...
document.addEventListener('DOMContentLoaded', () => {
    // Auto-show loading for elements with data-auto-loading attribute

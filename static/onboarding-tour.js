        ...
        this.steps = [
            {
                ...
                content: 'Your enterprise fleet intelligence platform with 717 assets and 92 drivers under management.',
                position: 'bottom'
            },
            {
                target: '[data-tour="fleet-overview"]',
                title: 'Fleet Overview',
                content: 'Monitor your active fleet status with real-time telematic data from GAUGE API integration.',
                position: 'bottom'
            },
            {
                target: '[data-tour="attendance-matrix"]',
                title: 'Attendance Intelligence',
                content: 'Automated attendance tracking with May 2025 report processing and overtime calculations.',
                position: 'right'
            },
            {
                target: '[data-tour="billing-automation"]',
                title: 'Billing Automation',
                content: 'Automated billing with authentic RAGLE data processing for equipment management.',
                position: 'left'
            },
            {
                target: '[data-tour="ai-intelligence"]',
                title: 'AI Intelligence Center',
                content: 'Fortune 500-grade predictive analytics with machine learning insights.',
                position: 'top'
            },
            {
                target: '[data-tour="voice-commands"]',
                title: 'Voice Commands',
                content: 'Use Alt+V or click the microphone for hands-free navigation. Try saying "dashboard" or "billing".',
                position: 'bottom'
            }
        ];
        this.overlay = null;
...
function addTourRestartButton() {
    ...
    restartBtn.style.cssText = 'position: fixed; bottom: 20px; right: 20px; z-index: 1000;';
    restartBtn.onclick = () => {
        tour.reset();
